...
```jsx
// Replace the file path with the correct filepath to VariantChooser
import VariantChooser from './filePathTo/VariantChooser';

// Replace the string provided to text with your own
<VariantChooser text='text content here' />
```
